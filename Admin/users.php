  ...
  <div id="addUserModal" class="modal">
    ...
    <div class="modal-container">
      <form id="addUserForm" method="POST" action="add_user.php">
        ...
        <div class="modal-content">
          <div class="input-group">
            <input type="text" name="contact" id="contact" class="input"  placeholder="contact number " minlength="10" maxlength="10" pattern="\d{10}" 
            title="Please enter exactly 10 digits."  oninput="this.value = this.value.replace(/\D/g, '').slice(0, 10);" required>
    ...
    <div class="modal-container">
      <form id="editUserForm" method="POST" action="edit_user.php">
        ...
        <div class="modal-content">
          ...
          <div class="input-group">
            <input type="text" name="contact" id="editContact"  class="input" 
