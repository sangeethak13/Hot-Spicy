...
if (isset($_SESSION['email'])) {
    ...
    if (isset($_POST['pid']) && isset($_POST['pname']) && isset($_POST['pprice'])) {
        ...
        if (!$code) {
            ...
            echo '<div id="cart-alert" class="alert alert-success alert-dismissible mt-2" style="width: 300px; position: fixed; top: 50%; right: 50%; transform: translate(50%, -50%); z-index: 9999; padding-top: 40px; padding-bottom: 40px; font-size: 17px; text-align: center;">
          ...
          <script>
            ...
            echo '<div id="cart1-alert" class="alert alert-danger alert-dismissible mt-2" style="width: 300px; position: fixed; top: 50%; right: 50%; transform: translate(50%, -50%); z-index: 9999; padding-top: 40px; padding-bottom: 40px; font-size: 17px; text-align: center;">
                      <button type="button" class="close" data-dismiss="alert">&times;</button>
            ...
            // Hide the alert after 1 seconds
            setTimeout(function() {
              var alert = document.getElementById("cart1-alert");
              if (alert) {
                alert.style.display = "none";
              }
            }, 1300);
