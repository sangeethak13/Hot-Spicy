	        ...
	        Email or Password is incorrect.
				...
				<form action="dbregister.php" class="sign-up-form" method="POST" id="registerForm">
					...
					<div class="input-field">
						...
						<input type="text" placeholder="First Name" name="firstName" onkeyup="hideAlertBox()" required oninput="this.value = this.value.replace(/[^A-Za-z\s\-' ]/g, '')" />
					</div>

					<div class="input-field">
						<i class="fas fa-user"></i>
						<input type="text" placeholder="Last Name" name="lastName" onkeyup="hideAlertBox()" required required oninput="this.value = this.value.replace(/[^A-Za-z\s\-' ]/g, '')" />
					...
					<div class="input-field">
						...
						<input type="text" name="contact" onkeyup="hideAlertBox()"
						placeholder="Contact No" minlength="10" maxlength="10" pattern="\d{10}" 
						title="Please enter exactly 10 digits." required  oninput="this.value = this.value.replace(/\D/g, '').slice(0, 10);">
